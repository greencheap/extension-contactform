                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="600" id="panel-table">
                        <tr>
                            <td valign="top" align="center" style="font-size: 16px; line-height: 24px; font-family: Helvetica, Arial, sans-serif; color: #666;">
                                ...
                                <h1 style="margin: 0 0 30px 0; padding-bottom: 25px; border-bottom: 1px solid #e5e5e5; font-size: 34px; line-height: 40px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333 !important;"><?= __('You have a new message') ?></h1>

                                <?php foreach($form as $key => $value): ?>
                                    <p style="margin: 20px 0; text-align: left;"><strong style="margin-right:10px"><?= $key ?></strong><?= $value ?></p>
                                <?php endforeach ?>
