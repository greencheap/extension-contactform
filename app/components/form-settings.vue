    ...
    <div class="uk-form-horizontal">
        ...
        <div class="uk-margin">
            ...
            <div class="uk-form-controls">
                ...
                <span class="uk-display-block uk-text-small uk-margin-small">{{
                    "Address to send the reply" | trans
                }}</span>
            </div>
        </div>
        ...
        <div v-if="getType == 'url'" class="uk-margin">
            <div class="uk-margin">
                <button
                    ...
                    @click.prevent="addValueHeader"
                >
                    {{ "Add Header Value" | trans }}
                </button>
            </div>
            <div v-if="form.data.headers.length">
                <label class="uk-form-label">{{
                    "Form Address Header" | trans
                }}</label>
                <div class="uk-form-controls">
                    <div
                        v-for="(header, id) in form.data.headers"
                        :key="id"
                    ...
                    >
                        <input
                            ...
                            class="uk-input uk-width-expand uk-margin-small-right"
                            v-model="header.name"
                        />
                        <input
                            type="input"
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-center">
                            <a
                                @click.prevent="deleteValueHeader(id)"
                                class="uk-margin-small-left"
                                uk-icon="icon:trash;ratio:1.2"
                                :uk-tooltip="'Delete Item' | trans"
                            ></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="uk-margin">
            <label class="uk-form-label">{{
                "If the post was successful" | trans
            }}</label>
            <div class="uk-form-controls">
                <input
                    type="text"
                    class="uk-input uk-form-width-large"
                    v-model="form.data.messages.success_send"
                    required
                />
            </div>
        </div>
        <div class="uk-margin">
            <label class="uk-form-label">{{
                "If sending fails" | trans
            }}</label>
            <div class="uk-form-controls">
                <input
                    type="text"
                    class="uk-input uk-form-width-large"
                    v-model="form.data.messages.error_send"
                    required
                />
            </div>
        </div>
        <div class="uk-margin">
            <label class="uk-form-label">{{
                "If it does not enter correct data" | trans
            }}</label>
            <div class="uk-form-controls">
                <input
                    type="text"
                    class="uk-input uk-form-width-large"
                    v-model="form.data.messages.error_invalid"
                    required
                />
            </div>
        </div>
        <div class="uk-margin">
            <label class="uk-form-label">{{
                "If mandatory fields are left blank" | trans
            }}</label>
            <div class="uk-form-controls">
                <input
                    type="text"
                    class="uk-input uk-form-width-large"
                    v-model="form.data.messages.error_validation"
                    required
                />
            </div>
        </div>
